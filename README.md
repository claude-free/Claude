# Claude 国内最新使用指南~ （支持 Claude 3.7 sonnet，稳定好用~）【2025年3月更新】

> 更新：**2025/03/28**          

在国内轻松使用 [**Claude 中文版**](https://chat.yixiaai.com) 教程，**无需翻墙**，**支持 Claude 3.7、Claude 3.5 及中文版功能**   

本指南提供全面的 **Claude 国内使用指南**，包括国内可用的 [**Claude 网页版**](https://chat.lanjing.ai)、[**Claude 国内入口**](https://chat.yixiaai.com)、[**Claude 官网平替**](https://chat.lanjing.ai) 和详细使用教程，帮助您快速使用上 Claude~
