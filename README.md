# Claude 国内最新使用指南~ （支持 Claude Sonnet 4、Claude 3.7，稳定好用~）【2025年10月更新】

> **更新日期：2025/09/30**                 

在国内轻松使用 [**Claude 中文版**](https://ai.lanjingai.org) 教程，**无需翻墙**，**支持 Claude 4、Claude 3.7、Claude 3.5 及中文版功能**   
...
- [ai.lanjingai.org](https://ai.lanjingai.org/) - **Claude 中文站**，支持 Claude 3.7 sonnet、Grok 3、GPT-4o、o1、o3 及 DeepSeek R1 最先进的模型，无限使用~
- [chat.lify.vip](https://chat.yixiaai.com) - **Claude 镜像网站**，支持 Claude-3.7、Claude-3.5、GPT-o1、o3及Groq-3，AI文件、AI PPT、AI助手、AI插件功能、思维导图~
- [ai.lanjing.pro](https://ai.lanjing.pro/) - **ChatGPT 镜像网站**，支持 GPT4、4o，支持AI绘画（Midjourney和Dall·E）
